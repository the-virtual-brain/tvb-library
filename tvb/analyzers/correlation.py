...
""" 
Calculate temporal cross correlation coefficient (Pearson's
...
class Correlate(core.Type):
    ...
    t_start = basic.Float(
        ...
        The starting time point of a time series is not zero, but the monitor sample period. """)
